...
import { SectionCard, FlexBox } from '@/components/layout';
import { ApiKeyField } from '@/components/forms';
import { alpha, themeColors } from '@/theme';
import type { ServiceEndpointsForm, ServiceEndpoints } from '../hooks';
            ...
            >
              <FlexBox align="center" gap={1} sx={{ mb: 2 }}>
                ...
                {currentEndpoints.apiKey?.trim() && (
                  ...
                  >
                    <Typography sx={{ fontSize: '0.7rem', color: themeColors.success, fontWeight: 600 }}>CONFIGURED</Typography>
                  </Box>
                )}
              </FlexBox>
              <Grid container spacing={2}>
