...
import { Box, TextField, IconButton, Button, InputAdornment } from '@/components/ui';
import { Visibility, VisibilityOff, Edit as EditIcon, VpnKey as KeyIcon, Lock as LockIcon } from '@mui/icons-material';
